...
diam_sjplot_rislope <- sjPlot::sjp.lmer(diam_model, type = "ri.slope")
...
diam_sjplot_rsri <- sjPlot::sjp.lmer(diam_model, type = "rs.ri", show.legend = T) 
...
rgr_rsri_sjplot <- sjPlot::sjp.lmer(rmod_herbiv3, type = "rs.ri", show.legend = T)# avg herbiv. incidence
# sjPlot::sjp.lmer(rmod_herbiv4, type = "rs.ri")# cumulative herbiv. incidence

rgr_rsri_plot <- rgr_rsri_sjplot$plot[[1]]
rgr_rsri_plot + theme_classic()
...
biomass_distance_lines <- biomass_distance_lines + 
  ...
  scale_color_brewer(palette = "BrBG") +
  xlab("")
diam_distance_lines <- diam_distance_lines + 
  theme(legend.position = "none") +
  scale_color_brewer(palette = "BrBG") +
  xlab("")
rgr_distance_lines <- rgr_distance_lines + 
  theme(legend.position = "none") +
  scale_color_brewer(palette = "BrBG")

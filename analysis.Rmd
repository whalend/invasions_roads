...
rmod_herbiv1 <- lmer(log(avg_diameter) ~ distance + avg_pct_light + age + avg_herbivory_06 + (1|site_code) + (1|common_name), data = site_grouped_data)
summary(rmod_herbiv1)

rmod_herbiv2 <- lmer(log(avg_diameter) ~ distance + avg_pct_light + age + avg_h_incidence_06 + (1|site_code) + (1|common_name), data = site_grouped_data)
...
rgr_model <- lmer(log(avg_diameter) ~ distance + avg_pct_light + age + avg_h_incidence_06 + (1|site_code) + (1|common_name), data = site_grouped_data, REML = T)
summary(rgr_model)
...
cowplot::plot_grid(plotlist = list(biomass_scaled_coef_plot, biomass_species_ranef_plot, biomass_distance_lines, diam_scaled_coef_plot, diam_species_ranef_plot, diam_distance_lines, rgr_scaled_coef_plot, rgr_species_ranef_plot, rgr_distance_lines), nrow = 3,ncol = 3)

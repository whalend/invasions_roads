...
(diam_hab_fig <- ggplot(seedling_data, aes(f_habitat, diameter06)) +
  stat_summary(aes(group = common_name, color = common_name), 
               fun.y = mean, geom = "line", 
               # position = position_jitterdodge(jitter.width = .1),
               show.legend = F) +
...
(biomass_hab_fig <- ggplot(seedling_data, aes(f_habitat, tot_biomass)) +
  stat_summary(aes(group = common_name, color = common_name), 
               fun.y = mean, geom = "line", 
               # position = position_jitterdodge(jitter.width = .1),
               show.legend = F) +
...
(rgr_hab_fig <- ggplot(seedling_data, aes(f_habitat, rgr_ht_days)) +
  stat_summary(aes(group = common_name, color = common_name), 
               fun.y = mean, geom = "line", 
               # position = position_jitterdodge(jitter.width = .1),
               show.legend = F) +
  ...
  theme(strip.background = element_blank(),
        panel.grid = element_blank(),
        legend.title = element_blank()) +
  ylab(expression(paste("Relative growth rate (% / day)"))) +
  xlab("Distance from edge") 
)
...
ggsave("figures/growth-raw.eps", width = 4.5, height = 10)

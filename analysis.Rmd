...
rgr_distance_lines <- rgr_distance +
  geom_abline(intercept = rgr_summary$coefficients[1,1], slope = )
  # geom_line() +
  # geom_point(data = site_grouped_data, aes(distance, log(avg_biomass))) +
  scale_color_brewer(palette = 7) +
...
```{r gridded-dot-line-plots, fig.height=10, fig.width=7}

cowplot::plot_grid(plotlist = list(
  biomass_scaled_coef_plot, biomass_species_ranef_plot, biomass_distance_lines, 
  diam_scaled_coef_plot, diam_species_ranef_plot, diam_distance_lines,
  rgr_scaled_coef_plot, rgr_species_ranef_plot, rgr_distance_lines), 
  nrow = 3, ncol = 3)

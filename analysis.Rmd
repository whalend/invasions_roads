...
```{r fig2-species-growth-diff, fig.width=9, fig.height=10, fig.asp=.5}
...
cowplot::plot_grid(plotlist = list(
  ...
  nrow = 3, ncol = 2, rel_widths = c(1,2), labels = "auto")

# ggsave(filename = "figures/distance-intercepts-fig2.eps", width = 9, height = 10)
